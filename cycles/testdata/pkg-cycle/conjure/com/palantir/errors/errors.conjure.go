...
import (
	...
	"github.com/palantir/conjure-go/v7/cycles/testdata/pkg-cycle/conjure/com/palantir/bar"
	"github.com/palantir/conjure-go/v7/cycles/testdata/pkg-cycle/conjure/internal/conjureerrors"
...
type myError struct {
	SafeArg1   bar.Type1 `json:"safeArg1"`
...
func (o *myError) UnmarshalJSON(data []byte) error {
	...
	if rawmyError.SafeArg1 == nil {
		rawmyError.SafeArg1 = make([]bar.Type3, 0)
	}
...
func NewMyError(safeArg1Arg bar.Type1, safeArg2Arg bar.Type2, unsafeArg3Arg bar.Type3) *MyError {
...
func WrapWithMyError(err error, safeArg1Arg bar.Type1, safeArg2Arg bar.Type2, unsafeArg3Arg bar.Type3) *MyError {
