...
import (
	...
	"github.com/palantir/conjure-go/v7/cycles/testdata/type-cycle/conjure/com/palantir/foo"
	"github.com/palantir/conjure-go/v7/cycles/testdata/type-cycle/conjure/internal/conjureerrors"
	"github.com/palantir/pkg/bearertoken"
	werror "github.com/palantir/witchcraft-go-error"
)

type MyServiceClient interface {
	Endpoint1(ctx context.Context, authHeader bearertoken.Token, arg1Arg buzz.Type1) (barfoo.Type4, error)
...
func (c *myServiceClient) Endpoint1(ctx context.Context, authHeader bearertoken.Token, arg1Arg buzz.Type1) (barfoo.Type4, error) {
	var returnVal *barfoo.Type4
	...
	if _, err := c.client.Get(ctx, requestParams...); err != nil {
		return *new(barfoo.Type4), werror.WrapWithContextParams(ctx, err, "Endpoint1 failed")
	}
	if returnVal == nil {
		return *new(barfoo.Type4), werror.ErrorWithContextParams(ctx, "Endpoint1 response cannot be nil")
	}
...
type MyServiceClientWithAuth interface {
	Endpoint1(ctx context.Context, arg1Arg buzz.Type1) (barfoo.Type4, error)
...
func (c *myServiceClientWithAuth) Endpoint1(ctx context.Context, arg1Arg buzz.Type1) (barfoo.Type4, error) {
...
func (c *myServiceClientWithTokenProvider) Endpoint1(ctx context.Context, arg1Arg buzz.Type1) (barfoo.Type4, error) {
	token, err := c.tokenProvider(ctx)
	if err != nil {
		return *new(barfoo.Type4), err
	}
