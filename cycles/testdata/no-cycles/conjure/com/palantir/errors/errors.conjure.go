...
import (
	...
	"github.com/palantir/conjure-go/v6/cycles/testdata/no-cycles/conjure/internal/conjureerrors"
...
type myError struct {
	SafeArg1   bar.Type1 `json:"safeArg1" yaml:"safeArg1"`
	SafeArg2   bar.Type2 `json:"safeArg2" yaml:"safeArg2"`
	UnsafeArg3 bar.Type3 `json:"unsafeArg3" yaml:"unsafeArg3"`
}
