...
func (o ArgumentDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Markers {
			if err := o.Markers[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
	...
	}
	{
		...
		for i := range o.Tags {
			if err := enc.WriteToken(jsontext.String(o.Tags[i])); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o ConjureDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Errors {
			if err := o.Errors[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
	...
	}
	{
		...
		for i := range o.Types {
			if err := o.Types[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
	...
	}
	{
		...
		for i := range o.Services {
			if err := o.Services[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o EndpointDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Args {
			if err := o.Args[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o EnumDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Values {
			if err := o.Values[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o ErrorDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.SafeArgs {
			if err := o.SafeArgs[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
	...
	}
	{
		...
		for i := range o.UnsafeArgs {
			if err := o.UnsafeArgs[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o ObjectDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Fields {
			if err := o.Fields[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o ServiceDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Endpoints {
			if err := o.Endpoints[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
...
func (o UnionDefinition) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	}
	{
		...
		for i := range o.Union {
			if err := o.Union[i].MarshalJSONTo(enc); err != nil {
				return err
			}
		}
		if err := enc.WriteToken(jsontext.EndArray); err != nil {
