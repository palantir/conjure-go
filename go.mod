...
require (
	...
	github.com/palantir/conjure-go-runtime/v2 v2.68.0
	...
	github.com/palantir/witchcraft-go-logging v1.48.0
	github.com/palantir/witchcraft-go-params v1.29.0
	github.com/palantir/witchcraft-go-server/v2 v2.70.0
	github.com/palantir/witchcraft-go-tracing v1.31.0
