...
func (u *Type3) AcceptFuncs(field1Func func(foo1.Type2) error, field2Func func(foo1.Type4) error, field3Func func(bar.Type1) error, unknownFunc func(string) error) error {
	switch u.typ {
	default:
		if u.typ == "" {
...
func (u *Type3) Field1NoopSuccess(foo1.Type2) error {
	return nil
}

func (u *Type3) Field2NoopSuccess(foo1.Type4) error {
	return nil
}
...
type Type3Visitor interface {
	VisitField1(v foo1.Type2) error
	VisitField2(v foo1.Type4) error
...
type Type3VisitorWithContext interface {
	VisitField1WithContext(ctx context.Context, v foo1.Type2) error
	VisitField2WithContext(ctx context.Context, v foo1.Type4) error
	VisitField3WithContext(ctx context.Context, v bar.Type1) error
	VisitUnknownWithContext(ctx context.Context, typeName string) error
}

func NewType3FromField1(v foo1.Type2) Type3 {
	return Type3{typ: "field1", field1: &v}
}

func NewType3FromField2(v foo1.Type4) Type3 {
