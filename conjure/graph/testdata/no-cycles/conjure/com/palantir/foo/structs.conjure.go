...
import (
	"github.com/palantir/conjure-go/v6/conjure/graph/testdata/no-cycles/conjure/com/palantir/buzz"
	"github.com/palantir/conjure-go/v6/conjure/graph/testdata/no-cycles/conjure/com/palantir/fizz"
...
func (o Type1) MarshalJSON() ([]byte, error) {
	if o.Field1 == nil {
		o.Field1 = make(map[fizz.Type1]Type4, 0)
	}
...
func (o *Type1) UnmarshalJSON(data []byte) error {
	...
	if rawType1.Field1 == nil {
		rawType1.Field1 = make(map[fizz.Type1]Type4, 0)
	}
	*o = Type1(rawType1)
	return nil
}
