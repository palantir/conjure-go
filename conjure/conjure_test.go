...
`,
	...
	{
		name: "full-featured service definition with product dependencies",
		src: `
{
	"version" : 1,
	"errors" : [ ],
...
`,
		wantFiles: map[string]string{
			"test/api/zz_generated_product_dependencies.go": `// This file was generated by Conjure and should not be manually edited.

package api

// product-dependencies: [{"maximum-version":"2.x.x","minimum-version":"2.78.0","product-group":"com.palantir.assetserver","product-name":"asset-server"}]
`,
			"test/api/services.conjure.go": `// This file was generated by Conjure and should not be manually edited.
