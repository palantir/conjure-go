...
// This directory contains all the tests that run using code generated by conjure-go. These tests are typically
// integration tests that make use of the code generated by conjure-go to verify its behavior. The generator generates
// all the generated files that are used by these tests.
