...
type TestServiceClient interface {
	BinaryAlias(ctx context.Context, bodyArg httpclient.RequestBody) (io.ReadCloser, error)
	BinaryAliasOptional(ctx context.Context) (*io.ReadCloser, error)
	BinaryAliasAlias(ctx context.Context, bodyArg httpclient.RequestBody) (*io.ReadCloser, error)
	Binary(ctx context.Context, bodyArg httpclient.RequestBody) (io.ReadCloser, error)
	BinaryOptional(ctx context.Context) (*io.ReadCloser, error)
	BinaryOptionalAlias(ctx context.Context, bodyArg httpclient.RequestBody) (*io.ReadCloser, error)
...
func (c *testServiceClient) BinaryList(ctx context.Context, bodyArg [][]byte) ([][]byte, error) {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[[][]byte, types.ListMarshaler[[][]byte, []byte, types.Binary[[]byte]]]{}))
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[[][]byte, types.ListUnmarshaler[[][]byte, []byte, types.Binary[[]byte]]]{}))
...
func (c *testServiceClient) Bytes(ctx context.Context, bodyArg CustomObject) (CustomObject, error) {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[CustomObject, types.StructMarshaler[CustomObject]]{}))
