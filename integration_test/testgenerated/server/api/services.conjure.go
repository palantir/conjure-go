...
type TestServiceClient interface {
	...
	PostBinary(ctx context.Context, myBytesArg httpclient.RequestBody) (io.ReadCloser, error)
	PutBinary(ctx context.Context, myBytesArg httpclient.RequestBody) error
...
func (c *testServiceClient) QueryParamSetDateTime(ctx context.Context, authHeader bearertoken.Token, myQueryParam1Arg []datetime.DateTime) ([]datetime.DateTime, error) {
	...
	requestParams = append(requestParams, httpclient.WithQueryValues(queryParams))
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[[]datetime.DateTime, cj.ListUnmarshaler[[]datetime.DateTime, datetime.DateTime, cj.TextUnmarshaler[*datetime.DateTime]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *testServiceClient) PostPathParam(ctx context.Context, authHeader bearertoken.Token, myPathParam1Arg string, myPathParam2Arg bool, myBodyParamArg CustomObject, myQueryParam1Arg string, myQueryParam2Arg string, myQueryParam3Arg float64, myQueryParam4Arg *safelong.SafeLong, myQueryParam5Arg *string, myQueryParam6Arg OptionalIntegerAlias, myHeaderParam1Arg safelong.SafeLong, myHeaderParam2Arg *uuid.UUID) (CustomObject, error) {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(myBodyParamArg, cj.ClientEncoder[CustomObject, cj.StructMarshaler[CustomObject]]{}))
...
func (c *testServiceClient) PostBinary(ctx context.Context, myBytesArg httpclient.RequestBody) (io.ReadCloser, error) {
	var requestParams []httpclient.RequestParam
	requestParams = append(requestParams, httpclient.WithRPCMethodName("PostBinary"))
	requestParams = append(requestParams, httpclient.WithRequestMethod("POST"))
	requestParams = append(requestParams, httpclient.WithPathf("/binary"))
	requestParams = append(requestParams, httpclient.WithBinaryRequestBody(myBytesArg))
	requestParams = append(requestParams, httpclient.WithRawResponseBody())
	resp, err := c.client.Do(ctx, requestParams...)
	if err != nil {
...
func (c *testServiceClient) PutBinary(ctx context.Context, myBytesArg httpclient.RequestBody) error {
	var requestParams []httpclient.RequestParam
...
func (c *testServiceClientWithAuth) PostBinary(ctx context.Context, myBytesArg httpclient.RequestBody) (io.ReadCloser, error) {
	return c.client.PostBinary(ctx, myBytesArg)
}

func (c *testServiceClientWithAuth) PutBinary(ctx context.Context, myBytesArg httpclient.RequestBody) error {
