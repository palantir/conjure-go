	...
	out += n0
	{
		...
		out += n2
		{
			...
			for i1, k1 := range mapKeys1 {
				...
				out += n5
				{
					n6, err := dj.WriteBase64(w, o.Map[k1])
					if err != nil {
						return 0, err
					}
					out += n6
	...
	out += n0
	{
		...
		out += n2
		{
			...
			for i1, k1 := range mapKeys1 {
				...
				{
					n4, err := dj.WriteBoolString(w, bool(mapKeysByString1[k1]))
					if err != nil {
						return 0, err
					}
					out += n4
				...
				out += n5
				{
					n6, err := dj.WriteInt(w, int64(o.Map[mapKeysByString1[k1]]))
					if err != nil {
						return 0, err
					}
					out += n6
...
func (o Collections) WriteJSON(w io.Writer) (int, error) {
	...
	out += n0
	{
		n1, err := dj.WriteLiteral(w, "\"mapVar\":")
		if err != nil {
			return 0, err
		}
		out += n1
			...
			for i1, k1 := range mapKeys1 {
				...
				out += n5
				{
					...
					for i2 := range o.MapVar[k1] {
						n7, err := dj.WriteInt(w, int64(o.MapVar[k1][i2]))
						if err != nil {
							return 0, err
						}
						out += n7
	...
	}
	{
		...
		out += n11
		n12, err := dj.WriteLiteral(w, "\"listVar\":")
		if err != nil {
			return 0, err
		}
		out += n12
		n13, err := dj.WriteOpenArray(w)
		if err != nil {
			return 0, err
		}
		out += n13
		for i := range o.ListVar {
			n14, err := dj.WriteString(w, o.ListVar[i])
			if err != nil {
				return 0, err
			}
			out += n14
	...
	}
	{
		...
		out += n17
		n18, err := dj.WriteLiteral(w, "\"multiDim\":")
		if err != nil {
			return 0, err
		}
		out += n18
		n19, err := dj.WriteOpenArray(w)
		if err != nil {
			return 0, err
		}
		out += n19
			...
			for i1 := range o.MultiDim[i] {
				...
				out += n21
				{
					...
					for i3, k3 := range mapKeys3 {
						...
						out += n24
						{
							n25, err := dj.WriteInt(w, int64(o.MultiDim[i][i1][k3]))
							if err != nil {
								return 0, err
							}
							out += n25
...
func (o Compound) WriteJSON(w io.Writer) (int, error) {
	...
	out += n0
	{
		n1, err := dj.WriteLiteral(w, "\"obj\":")
		if err != nil {
			return 0, err
		}
		out += n1
		n2, err := o.Obj.WriteJSON(w)
		if err != nil {
			return 0, err
		}
		out += n2
...
func (o ExampleUuid) WriteJSON(w io.Writer) (int, error) {
	...
	out += n0
	{
		n1, err := dj.WriteLiteral(w, "\"uid\":")
		if err != nil {
			return 0, err
		}
		out += n1
		n2, err := dj.WriteString(w, o.Uid.String())
		if err != nil {
			return 0, err
		}
		out += n2
			...
			for i1, k1 := range mapKeys1 {
				...
				out += n5
				{
					if o.Map[k1].Value != nil {
						...
						n6, err := dj.WriteString(w, optVal.String())
						if err != nil {
							return 0, err
						}
						out += n6
...
func (o MapStringAnyObject) WriteJSON(w io.Writer) (int, error) {
	...
	out += n0
	{
		n1, err := dj.WriteLiteral(w, "\"mapStringAny\":")
		if err != nil {
			return 0, err
		}
		out += n1
			...
			for i1, k1 := range mapKeys1 {
				...
				out += n5
				{
					if map[string]interface{}(o.MapStringAny)[k1] == nil {
						n6, err := dj.WriteNull(w)
						if err != nil {
							return 0, err
						}
						out += n6
					} else {
						n7, err := dj.WriteObject(w, map[string]interface{}(o.MapStringAny)[k1])
						if err != nil {
							return 0, err
						}
						out += n7
	...
	}
	{
		...
		out += n9
		n10, err := dj.WriteLiteral(w, "\"mapStringAnyAlias\":")
		if err != nil {
			return 0, err
		}
		out += n10
			...
			for i1, k1 := range mapKeys1 {
				...
				out += n14
				{
					if interface{}(map[string]AnyAlias(o.MapStringAnyAlias)[k1]) == nil {
						...
						n16, err := dj.WriteObject(w, interface{}(map[string]AnyAlias(o.MapStringAnyAlias)[k1]))
						if err != nil {
							return 0, err
						}
						out += n16
...
func (o OptionalFields) WriteJSON(w io.Writer) (int, error) {
	...
	}
	{
		...
		n7, err := dj.WriteLiteral(w, "\"reqd\":")
		if err != nil {
			return 0, err
		}
		out += n7
		n8, err := dj.WriteString(w, o.Reqd)
		if err != nil {
			return 0, err
		}
		out += n8
	...
	if o.Opt3.Value != nil {
		...
		out += n9
		n10, err := dj.WriteLiteral(w, "\"opt3\":")
		if err != nil {
			return 0, err
		}
		out += n10
...
func (o Type) WriteJSON(w io.Writer) (int, error) {
	...
	out += n0
	{
		...
		out += n2
		for i := range o.Type {
			n3, err := dj.WriteString(w, o.Type[i])
			if err != nil {
				return 0, err
			}
			out += n3
	...
	}
	{
		...
		out += n6
		n7, err := dj.WriteLiteral(w, "\"chan\":")
		if err != nil {
			return 0, err
		}
		out += n7
		n8, err := dj.WriteOpenObject(w)
		if err != nil {
			return 0, err
		}
		out += n8
		{
			...
			for i1, k1 := range mapKeys1 {
				...
				{
					n10, err := dj.WriteString(w, k1)
					if err != nil {
						return 0, err
					}
					out += n10
				}
				n11, err := dj.WriteColon(w)
				if err != nil {
					return 0, err
				}
				out += n11
				{
					n12, err := dj.WriteString(w, o.Chan[k1])
					if err != nil {
						return 0, err
					}
					out += n12
