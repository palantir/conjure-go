...
func (a AliasOptionalEnum) MarshalJSON() ([]byte, error) {
	if a.Value == nil {
...
func (a OptionalAliasEnum) MarshalJSON() ([]byte, error) {
	if a.Value == nil {
		return []byte("null"), nil
	}
	return safejson.Marshal(a.Value)
...
func (a OptionalAliasString) MarshalJSON() ([]byte, error) {
	if a.Value == nil {
		return []byte("null"), nil
	}
	return safejson.Marshal(a.Value)
...
func (a OptionalAliasUuid) MarshalJSON() ([]byte, error) {
	if a.Value == nil {
		return []byte("null"), nil
	}
	return safejson.Marshal(a.Value)
