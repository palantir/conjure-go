...
type Dataset struct {
	...
	Rid conjuretype.ResourceIdentifier ` + "`" + `json:"rid" yaml:"rid,omitempty" conjure-docs:"Uniquely identifies this dataset."` + "`" + `
}
`,
...
type ExampleServiceClient interface {
	...
	GetDataset(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier) (*datasets.Dataset, error)
	GetBranches(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error)
	// Gets all branches of this dataset.
	GetBranchesDeprecated(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error)
	ResolveBranch(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier, branchArg string) (*string, error)
	TestParam(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) (*string, error)
...
func (c *exampleServiceClient) GetDataset(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier) (*datasets.Dataset, error) {
	var returnVal *datasets.Dataset
	var requestParams []httpclient.RequestParam
...
func (c *exampleServiceClient) GetBranches(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error) {
...
func (c *exampleServiceClient) GetBranchesDeprecated(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error) {
	var returnVal []string
	var requestParams []httpclient.RequestParam
...
func (c *exampleServiceClient) ResolveBranch(ctx context.Context, authHeader string, datasetRidArg conjuretype.ResourceIdentifier, branchArg string) (*string, error) {
	var returnVal *string
	var requestParams []httpclient.RequestParam
...
func (c *exampleServiceClient) TestParam(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) (*string, error) {
	var returnVal *string
	var requestParams []httpclient.RequestParam
...
type ExampleServiceClientWithAuth interface {
	...
	GetDataset(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) (*datasets.Dataset, error)
	GetBranches(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error)
	// Gets all branches of this dataset.
	GetBranchesDeprecated(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error)
	ResolveBranch(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier, branchArg string) (*string, error)
	TestParam(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) (*string, error)
...
func (c *exampleServiceClientWithAuth) GetDataset(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) (*datasets.Dataset, error) {
	return c.client.GetDataset(ctx, c.authHeader, datasetRidArg)
}

func (c *exampleServiceClientWithAuth) GetBranches(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error) {
	return c.client.GetBranches(ctx, c.authHeader, datasetRidArg)
}

func (c *exampleServiceClientWithAuth) GetBranchesDeprecated(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) ([]string, error) {
	return c.client.GetBranchesDeprecated(ctx, c.authHeader, datasetRidArg)
}

func (c *exampleServiceClientWithAuth) ResolveBranch(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier, branchArg string) (*string, error) {
	return c.client.ResolveBranch(ctx, c.authHeader, datasetRidArg, branchArg)
}

func (c *exampleServiceClientWithAuth) TestParam(ctx context.Context, datasetRidArg conjuretype.ResourceIdentifier) (*string, error) {
