...
func (c *autoDeserializeConfirmServiceClient) Confirm(ctx context.Context, endpointArg EndpointName, indexArg int, bodyArg interface{}) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[interface{}, types1.Any[interface{}]]{}))
...
func (c *autoDeserializeConfirmServiceClient) ReceiveBearerTokenExample(ctx context.Context, indexArg int, bodyArg types.BearerTokenExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.BearerTokenExample, types1.StructMarshaler[types.BearerTokenExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveBinaryExample(ctx context.Context, indexArg int, bodyArg types.BinaryExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.BinaryExample, types1.StructMarshaler[types.BinaryExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveBooleanExample(ctx context.Context, indexArg int, bodyArg types.BooleanExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.BooleanExample, types1.StructMarshaler[types.BooleanExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveDateTimeExample(ctx context.Context, indexArg int, bodyArg types.DateTimeExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.DateTimeExample, types1.StructMarshaler[types.DateTimeExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveDoubleExample(ctx context.Context, indexArg int, bodyArg types.DoubleExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.DoubleExample, types1.StructMarshaler[types.DoubleExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveIntegerExample(ctx context.Context, indexArg int, bodyArg types.IntegerExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.IntegerExample, types1.StructMarshaler[types.IntegerExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveRidExample(ctx context.Context, indexArg int, bodyArg types.RidExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.RidExample, types1.StructMarshaler[types.RidExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSafeLongExample(ctx context.Context, indexArg int, bodyArg types.SafeLongExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SafeLongExample, types1.StructMarshaler[types.SafeLongExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveStringExample(ctx context.Context, indexArg int, bodyArg types.StringExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.StringExample, types1.StructMarshaler[types.StringExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveUuidExample(ctx context.Context, indexArg int, bodyArg types.UuidExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.UuidExample, types1.StructMarshaler[types.UuidExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveAnyExample(ctx context.Context, indexArg int, bodyArg types.AnyExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.AnyExample, types1.StructMarshaler[types.AnyExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveEnumExample(ctx context.Context, indexArg int, bodyArg types.EnumExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.EnumExample, types1.StringerMarshaler[types.EnumExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListExample(ctx context.Context, indexArg int, bodyArg types.ListExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListExample, types1.StructMarshaler[types.ListExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetStringExample(ctx context.Context, indexArg int, bodyArg types.SetStringExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetStringExample, types1.StructMarshaler[types.SetStringExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetDoubleExample(ctx context.Context, indexArg int, bodyArg types.SetDoubleExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetDoubleExample, types1.StructMarshaler[types.SetDoubleExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapExample(ctx context.Context, indexArg int, bodyArg types.MapExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapExample, types1.StructMarshaler[types.MapExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalExample(ctx context.Context, indexArg int, bodyArg types.OptionalExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalExample, types1.StructMarshaler[types.OptionalExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalBooleanExample(ctx context.Context, indexArg int, bodyArg types.OptionalBooleanExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalBooleanExample, types1.StructMarshaler[types.OptionalBooleanExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalIntegerExample(ctx context.Context, indexArg int, bodyArg types.OptionalIntegerExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalIntegerExample, types1.StructMarshaler[types.OptionalIntegerExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveLongFieldNameOptionalExample(ctx context.Context, indexArg int, bodyArg types.LongFieldNameOptionalExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.LongFieldNameOptionalExample, types1.StructMarshaler[types.LongFieldNameOptionalExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveRawOptionalExample(ctx context.Context, indexArg int, bodyArg types.RawOptionalExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.RawOptionalExample, types1.StructMarshaler[types.RawOptionalExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveStringAliasExample(ctx context.Context, indexArg int, bodyArg types.StringAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.StringAliasExample, types1.String[types.StringAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveDoubleAliasExample(ctx context.Context, indexArg int, bodyArg types.DoubleAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.DoubleAliasExample, types1.Float[types.DoubleAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveIntegerAliasExample(ctx context.Context, indexArg int, bodyArg types.IntegerAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.IntegerAliasExample, types1.Int32[types.IntegerAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveBooleanAliasExample(ctx context.Context, indexArg int, bodyArg types.BooleanAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.BooleanAliasExample, types1.Boolean[types.BooleanAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSafeLongAliasExample(ctx context.Context, indexArg int, bodyArg types.SafeLongAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SafeLongAliasExample, types1.SafeLong[types.SafeLongAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveRidAliasExample(ctx context.Context, indexArg int, bodyArg types.RidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.RidAliasExample, types1.RID[types.RidAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveBearerTokenAliasExample(ctx context.Context, indexArg int, bodyArg types.BearerTokenAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.BearerTokenAliasExample, types1.BearerToken[types.BearerTokenAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveUuidAliasExample(ctx context.Context, indexArg int, bodyArg types.UuidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.UuidAliasExample, types1.UUID[types.UuidAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveReferenceAliasExample(ctx context.Context, indexArg int, bodyArg types.ReferenceAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ReferenceAliasExample, types1.StructMarshaler[types.ReferenceAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveKebabCaseObjectExample(ctx context.Context, indexArg int, bodyArg types.KebabCaseObjectExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.KebabCaseObjectExample, types1.StructMarshaler[types.KebabCaseObjectExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSnakeCaseObjectExample(ctx context.Context, indexArg int, bodyArg types.SnakeCaseObjectExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SnakeCaseObjectExample, types1.StructMarshaler[types.SnakeCaseObjectExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalBearerTokenAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalBearerTokenAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalBearerTokenAliasExample, types1.StructMarshaler[types.OptionalBearerTokenAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalBooleanAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalBooleanAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalBooleanAliasExample, types1.StructMarshaler[types.OptionalBooleanAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalDateTimeAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalDateTimeAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalDateTimeAliasExample, types1.StructMarshaler[types.OptionalDateTimeAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalDoubleAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalDoubleAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalDoubleAliasExample, types1.StructMarshaler[types.OptionalDoubleAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalIntegerAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalIntegerAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalIntegerAliasExample, types1.StructMarshaler[types.OptionalIntegerAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalRidAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalRidAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalRidAliasExample, types1.StructMarshaler[types.OptionalRidAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalSafeLongAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalSafeLongAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalSafeLongAliasExample, types1.StructMarshaler[types.OptionalSafeLongAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalStringAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalStringAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalStringAliasExample, types1.StructMarshaler[types.OptionalStringAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalUuidAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalUuidAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalUuidAliasExample, types1.StructMarshaler[types.OptionalUuidAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveOptionalAnyAliasExample(ctx context.Context, indexArg int, bodyArg types.OptionalAnyAliasExample) error {
	...
	if bodyArg.Value != nil {
		requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.OptionalAnyAliasExample, types1.StructMarshaler[types.OptionalAnyAliasExample]]{}))
	}
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListBearerTokenAliasExample(ctx context.Context, indexArg int, bodyArg types.ListBearerTokenAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListBearerTokenAliasExample, types1.ListMarshaler[types.ListBearerTokenAliasExample, bearertoken.Token, types1.BearerToken[bearertoken.Token]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListBinaryAliasExample(ctx context.Context, indexArg int, bodyArg types.ListBinaryAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListBinaryAliasExample, types1.ListMarshaler[types.ListBinaryAliasExample, []byte, types1.Binary[[]byte]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListBooleanAliasExample(ctx context.Context, indexArg int, bodyArg types.ListBooleanAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListBooleanAliasExample, types1.ListMarshaler[types.ListBooleanAliasExample, bool, types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListDoubleAliasExample(ctx context.Context, indexArg int, bodyArg types.ListDoubleAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListDoubleAliasExample, types1.ListMarshaler[types.ListDoubleAliasExample, float64, types1.Float[float64]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListIntegerAliasExample(ctx context.Context, indexArg int, bodyArg types.ListIntegerAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListIntegerAliasExample, types1.ListMarshaler[types.ListIntegerAliasExample, int, types1.Int32[int]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListRidAliasExample(ctx context.Context, indexArg int, bodyArg types.ListRidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListRidAliasExample, types1.ListMarshaler[types.ListRidAliasExample, rid.ResourceIdentifier, types1.RID[rid.ResourceIdentifier]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListSafeLongAliasExample(ctx context.Context, indexArg int, bodyArg types.ListSafeLongAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListSafeLongAliasExample, types1.ListMarshaler[types.ListSafeLongAliasExample, safelong.SafeLong, types1.SafeLong[safelong.SafeLong]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListStringAliasExample(ctx context.Context, indexArg int, bodyArg types.ListStringAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListStringAliasExample, types1.ListMarshaler[types.ListStringAliasExample, string, types1.String[string]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListUuidAliasExample(ctx context.Context, indexArg int, bodyArg types.ListUuidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListUuidAliasExample, types1.ListMarshaler[types.ListUuidAliasExample, uuid.UUID, types1.UUID[uuid.UUID]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListAnyAliasExample(ctx context.Context, indexArg int, bodyArg types.ListAnyAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListAnyAliasExample, types1.ListMarshaler[types.ListAnyAliasExample, interface{}, types1.Any[interface{}]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveListOptionalAnyAliasExample(ctx context.Context, indexArg int, bodyArg types.ListOptionalAnyAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.ListOptionalAnyAliasExample, types1.ListMarshaler[types.ListOptionalAnyAliasExample, *interface{}, types1.OptionalMarshaler[*interface{}, interface{}, types1.Any[interface{}]]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetBearerTokenAliasExample(ctx context.Context, indexArg int, bodyArg types.SetBearerTokenAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetBearerTokenAliasExample, types1.ListMarshaler[types.SetBearerTokenAliasExample, bearertoken.Token, types1.BearerToken[bearertoken.Token]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetBinaryAliasExample(ctx context.Context, indexArg int, bodyArg types.SetBinaryAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetBinaryAliasExample, types1.ListMarshaler[types.SetBinaryAliasExample, []byte, types1.Binary[[]byte]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetBooleanAliasExample(ctx context.Context, indexArg int, bodyArg types.SetBooleanAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetBooleanAliasExample, types1.ListMarshaler[types.SetBooleanAliasExample, bool, types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetDoubleAliasExample(ctx context.Context, indexArg int, bodyArg types.SetDoubleAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetDoubleAliasExample, types1.ListMarshaler[types.SetDoubleAliasExample, float64, types1.Float[float64]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetIntegerAliasExample(ctx context.Context, indexArg int, bodyArg types.SetIntegerAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetIntegerAliasExample, types1.ListMarshaler[types.SetIntegerAliasExample, int, types1.Int32[int]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetRidAliasExample(ctx context.Context, indexArg int, bodyArg types.SetRidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetRidAliasExample, types1.ListMarshaler[types.SetRidAliasExample, rid.ResourceIdentifier, types1.RID[rid.ResourceIdentifier]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetSafeLongAliasExample(ctx context.Context, indexArg int, bodyArg types.SetSafeLongAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetSafeLongAliasExample, types1.ListMarshaler[types.SetSafeLongAliasExample, safelong.SafeLong, types1.SafeLong[safelong.SafeLong]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetStringAliasExample(ctx context.Context, indexArg int, bodyArg types.SetStringAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetStringAliasExample, types1.ListMarshaler[types.SetStringAliasExample, string, types1.String[string]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetUuidAliasExample(ctx context.Context, indexArg int, bodyArg types.SetUuidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetUuidAliasExample, types1.ListMarshaler[types.SetUuidAliasExample, uuid.UUID, types1.UUID[uuid.UUID]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetAnyAliasExample(ctx context.Context, indexArg int, bodyArg types.SetAnyAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetAnyAliasExample, types1.ListMarshaler[types.SetAnyAliasExample, interface{}, types1.Any[interface{}]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveSetOptionalAnyAliasExample(ctx context.Context, indexArg int, bodyArg types.SetOptionalAnyAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.SetOptionalAnyAliasExample, types1.ListMarshaler[types.SetOptionalAnyAliasExample, *interface{}, types1.OptionalMarshaler[*interface{}, interface{}, types1.Any[interface{}]]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapBearerTokenAliasExample(ctx context.Context, indexArg int, bodyArg types.MapBearerTokenAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapBearerTokenAliasExample, types1.OrderedMapMarshaler[types.MapBearerTokenAliasExample, bearertoken.Token, bool, types1.BearerToken[bearertoken.Token], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapBinaryAliasExample(ctx context.Context, indexArg int, bodyArg types.MapBinaryAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapBinaryAliasExample, types1.OrderedMapMarshaler[types.MapBinaryAliasExample, binary.Binary, bool, types1.BinaryMapKey[binary.Binary], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapBooleanAliasExample(ctx context.Context, indexArg int, bodyArg types.MapBooleanAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapBooleanAliasExample, types1.ComparableMapMarshaler[types.MapBooleanAliasExample, boolean.Boolean, bool, types1.BooleanMapKey[boolean.Boolean], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapDoubleAliasExample(ctx context.Context, indexArg int, bodyArg types.MapDoubleAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapDoubleAliasExample, types1.OrderedMapMarshaler[types.MapDoubleAliasExample, float64, bool, types1.FloatMapKey[float64], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapIntegerAliasExample(ctx context.Context, indexArg int, bodyArg types.MapIntegerAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapIntegerAliasExample, types1.OrderedMapMarshaler[types.MapIntegerAliasExample, int, bool, types1.Int32MapKey[int], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapRidAliasExample(ctx context.Context, indexArg int, bodyArg types.MapRidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapRidAliasExample, types1.ComparableMapMarshaler[types.MapRidAliasExample, rid.ResourceIdentifier, bool, types1.RID[rid.ResourceIdentifier], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapSafeLongAliasExample(ctx context.Context, indexArg int, bodyArg types.MapSafeLongAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapSafeLongAliasExample, types1.OrderedMapMarshaler[types.MapSafeLongAliasExample, safelong.SafeLong, bool, types1.SafeLongMapKey[safelong.SafeLong], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapStringAliasExample(ctx context.Context, indexArg int, bodyArg types.MapStringAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapStringAliasExample, types1.OrderedMapMarshaler[types.MapStringAliasExample, string, bool, types1.String[string], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapUuidAliasExample(ctx context.Context, indexArg int, bodyArg types.MapUuidAliasExample) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapUuidAliasExample, types1.ComparableMapMarshaler[types.MapUuidAliasExample, uuid.UUID, bool, types1.UUID[uuid.UUID], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeConfirmServiceClient) ReceiveMapEnumExampleAlias(ctx context.Context, indexArg int, bodyArg types.MapEnumExampleAlias) error {
	...
	requestParams = append(requestParams, httpclient.WithRequestBody(bodyArg, cj.ClientEncoder[types.MapEnumExampleAlias, types1.ComparableMapMarshaler[types.MapEnumExampleAlias, types.EnumExample, string, types1.StringerMarshaler[types.EnumExample], types1.String[string]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveBearerTokenExample(ctx context.Context, indexArg int) (types.BearerTokenExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.BearerTokenExample, types1.StructUnmarshaler[*types.BearerTokenExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveBinaryExample(ctx context.Context, indexArg int) (types.BinaryExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.BinaryExample, types1.StructUnmarshaler[*types.BinaryExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveBooleanExample(ctx context.Context, indexArg int) (types.BooleanExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.BooleanExample, types1.StructUnmarshaler[*types.BooleanExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveDateTimeExample(ctx context.Context, indexArg int) (types.DateTimeExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.DateTimeExample, types1.StructUnmarshaler[*types.DateTimeExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveDoubleExample(ctx context.Context, indexArg int) (types.DoubleExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.DoubleExample, types1.StructUnmarshaler[*types.DoubleExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveRidExample(ctx context.Context, indexArg int) (types.RidExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.RidExample, types1.StructUnmarshaler[*types.RidExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSafeLongExample(ctx context.Context, indexArg int) (types.SafeLongExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SafeLongExample, types1.StructUnmarshaler[*types.SafeLongExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveStringExample(ctx context.Context, indexArg int) (types.StringExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.StringExample, types1.StructUnmarshaler[*types.StringExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveUuidExample(ctx context.Context, indexArg int) (types.UuidExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.UuidExample, types1.StructUnmarshaler[*types.UuidExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveAnyExample(ctx context.Context, indexArg int) (types.AnyExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.AnyExample, types1.StructUnmarshaler[*types.AnyExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveEnumExample(ctx context.Context, indexArg int) (types.EnumExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.EnumExample, types1.TextUnmarshaler[*types.EnumExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListExample(ctx context.Context, indexArg int) (types.ListExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListExample, types1.StructUnmarshaler[*types.ListExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetStringExample(ctx context.Context, indexArg int) (types.SetStringExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetStringExample, types1.StructUnmarshaler[*types.SetStringExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetDoubleExample(ctx context.Context, indexArg int) (types.SetDoubleExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetDoubleExample, types1.StructUnmarshaler[*types.SetDoubleExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapExample(ctx context.Context, indexArg int) (types.MapExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapExample, types1.StructUnmarshaler[*types.MapExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalExample(ctx context.Context, indexArg int) (types.OptionalExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalExample, types1.StructUnmarshaler[*types.OptionalExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalBooleanExample(ctx context.Context, indexArg int) (types.OptionalBooleanExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalBooleanExample, types1.StructUnmarshaler[*types.OptionalBooleanExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalIntegerExample(ctx context.Context, indexArg int) (types.OptionalIntegerExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalIntegerExample, types1.StructUnmarshaler[*types.OptionalIntegerExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveLongFieldNameOptionalExample(ctx context.Context, indexArg int) (types.LongFieldNameOptionalExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.LongFieldNameOptionalExample, types1.StructUnmarshaler[*types.LongFieldNameOptionalExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveRawOptionalExample(ctx context.Context, indexArg int) (types.RawOptionalExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.RawOptionalExample, types1.StructUnmarshaler[*types.RawOptionalExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveStringAliasExample(ctx context.Context, indexArg int) (types.StringAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.StringAliasExample, types1.String[types.StringAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveDoubleAliasExample(ctx context.Context, indexArg int) (types.DoubleAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.DoubleAliasExample, types1.Float[types.DoubleAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveIntegerAliasExample(ctx context.Context, indexArg int) (types.IntegerAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.IntegerAliasExample, types1.Int32[types.IntegerAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveBooleanAliasExample(ctx context.Context, indexArg int) (types.BooleanAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.BooleanAliasExample, types1.Boolean[types.BooleanAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSafeLongAliasExample(ctx context.Context, indexArg int) (types.SafeLongAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SafeLongAliasExample, types1.SafeLong[types.SafeLongAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveRidAliasExample(ctx context.Context, indexArg int) (types.RidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.RidAliasExample, types1.RID[types.RidAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveBearerTokenAliasExample(ctx context.Context, indexArg int) (types.BearerTokenAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.BearerTokenAliasExample, types1.BearerToken[types.BearerTokenAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveUuidAliasExample(ctx context.Context, indexArg int) (types.UuidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.UuidAliasExample, types1.UUID[types.UuidAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveReferenceAliasExample(ctx context.Context, indexArg int) (types.ReferenceAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ReferenceAliasExample, types1.StructUnmarshaler[*types.ReferenceAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveKebabCaseObjectExample(ctx context.Context, indexArg int) (types.KebabCaseObjectExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.KebabCaseObjectExample, types1.StructUnmarshaler[*types.KebabCaseObjectExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSnakeCaseObjectExample(ctx context.Context, indexArg int) (types.SnakeCaseObjectExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SnakeCaseObjectExample, types1.StructUnmarshaler[*types.SnakeCaseObjectExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalBearerTokenAliasExample(ctx context.Context, indexArg int) (types.OptionalBearerTokenAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalBearerTokenAliasExample, types1.StructUnmarshaler[*types.OptionalBearerTokenAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalBooleanAliasExample(ctx context.Context, indexArg int) (types.OptionalBooleanAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalBooleanAliasExample, types1.StructUnmarshaler[*types.OptionalBooleanAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalDateTimeAliasExample(ctx context.Context, indexArg int) (types.OptionalDateTimeAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalDateTimeAliasExample, types1.StructUnmarshaler[*types.OptionalDateTimeAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalDoubleAliasExample(ctx context.Context, indexArg int) (types.OptionalDoubleAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalDoubleAliasExample, types1.StructUnmarshaler[*types.OptionalDoubleAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalIntegerAliasExample(ctx context.Context, indexArg int) (types.OptionalIntegerAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalIntegerAliasExample, types1.StructUnmarshaler[*types.OptionalIntegerAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalRidAliasExample(ctx context.Context, indexArg int) (types.OptionalRidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalRidAliasExample, types1.StructUnmarshaler[*types.OptionalRidAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalSafeLongAliasExample(ctx context.Context, indexArg int) (types.OptionalSafeLongAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalSafeLongAliasExample, types1.StructUnmarshaler[*types.OptionalSafeLongAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalStringAliasExample(ctx context.Context, indexArg int) (types.OptionalStringAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalStringAliasExample, types1.StructUnmarshaler[*types.OptionalStringAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalUuidAliasExample(ctx context.Context, indexArg int) (types.OptionalUuidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalUuidAliasExample, types1.StructUnmarshaler[*types.OptionalUuidAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveOptionalAnyAliasExample(ctx context.Context, indexArg int) (types.OptionalAnyAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.OptionalAnyAliasExample, types1.StructUnmarshaler[*types.OptionalAnyAliasExample]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListBearerTokenAliasExample(ctx context.Context, indexArg int) (types.ListBearerTokenAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListBearerTokenAliasExample, types1.ListUnmarshaler[types.ListBearerTokenAliasExample, bearertoken.Token, types1.BearerToken[bearertoken.Token]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListBinaryAliasExample(ctx context.Context, indexArg int) (types.ListBinaryAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListBinaryAliasExample, types1.ListUnmarshaler[types.ListBinaryAliasExample, []byte, types1.Binary[[]byte]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListBooleanAliasExample(ctx context.Context, indexArg int) (types.ListBooleanAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListBooleanAliasExample, types1.ListUnmarshaler[types.ListBooleanAliasExample, bool, types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListDoubleAliasExample(ctx context.Context, indexArg int) (types.ListDoubleAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListDoubleAliasExample, types1.ListUnmarshaler[types.ListDoubleAliasExample, float64, types1.Float[float64]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListIntegerAliasExample(ctx context.Context, indexArg int) (types.ListIntegerAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListIntegerAliasExample, types1.ListUnmarshaler[types.ListIntegerAliasExample, int, types1.Int32[int]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListRidAliasExample(ctx context.Context, indexArg int) (types.ListRidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListRidAliasExample, types1.ListUnmarshaler[types.ListRidAliasExample, rid.ResourceIdentifier, types1.RID[rid.ResourceIdentifier]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListSafeLongAliasExample(ctx context.Context, indexArg int) (types.ListSafeLongAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListSafeLongAliasExample, types1.ListUnmarshaler[types.ListSafeLongAliasExample, safelong.SafeLong, types1.SafeLong[safelong.SafeLong]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListStringAliasExample(ctx context.Context, indexArg int) (types.ListStringAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListStringAliasExample, types1.ListUnmarshaler[types.ListStringAliasExample, string, types1.String[string]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListUuidAliasExample(ctx context.Context, indexArg int) (types.ListUuidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListUuidAliasExample, types1.ListUnmarshaler[types.ListUuidAliasExample, uuid.UUID, types1.UUID[uuid.UUID]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListAnyAliasExample(ctx context.Context, indexArg int) (types.ListAnyAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListAnyAliasExample, types1.ListUnmarshaler[types.ListAnyAliasExample, interface{}, types1.Any[interface{}]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveListOptionalAnyAliasExample(ctx context.Context, indexArg int) (types.ListOptionalAnyAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.ListOptionalAnyAliasExample, types1.ListUnmarshaler[types.ListOptionalAnyAliasExample, *interface{}, types1.OptionalUnmarshaler[*interface{}, interface{}, types1.Any[interface{}]]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetBearerTokenAliasExample(ctx context.Context, indexArg int) (types.SetBearerTokenAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetBearerTokenAliasExample, types1.ListUnmarshaler[types.SetBearerTokenAliasExample, bearertoken.Token, types1.BearerToken[bearertoken.Token]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetBinaryAliasExample(ctx context.Context, indexArg int) (types.SetBinaryAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetBinaryAliasExample, types1.ListUnmarshaler[types.SetBinaryAliasExample, []byte, types1.Binary[[]byte]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetBooleanAliasExample(ctx context.Context, indexArg int) (types.SetBooleanAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetBooleanAliasExample, types1.ListUnmarshaler[types.SetBooleanAliasExample, bool, types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetDoubleAliasExample(ctx context.Context, indexArg int) (types.SetDoubleAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetDoubleAliasExample, types1.ListUnmarshaler[types.SetDoubleAliasExample, float64, types1.Float[float64]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetIntegerAliasExample(ctx context.Context, indexArg int) (types.SetIntegerAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetIntegerAliasExample, types1.ListUnmarshaler[types.SetIntegerAliasExample, int, types1.Int32[int]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetRidAliasExample(ctx context.Context, indexArg int) (types.SetRidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetRidAliasExample, types1.ListUnmarshaler[types.SetRidAliasExample, rid.ResourceIdentifier, types1.RID[rid.ResourceIdentifier]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetSafeLongAliasExample(ctx context.Context, indexArg int) (types.SetSafeLongAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetSafeLongAliasExample, types1.ListUnmarshaler[types.SetSafeLongAliasExample, safelong.SafeLong, types1.SafeLong[safelong.SafeLong]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetStringAliasExample(ctx context.Context, indexArg int) (types.SetStringAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetStringAliasExample, types1.ListUnmarshaler[types.SetStringAliasExample, string, types1.String[string]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetUuidAliasExample(ctx context.Context, indexArg int) (types.SetUuidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetUuidAliasExample, types1.ListUnmarshaler[types.SetUuidAliasExample, uuid.UUID, types1.UUID[uuid.UUID]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetAnyAliasExample(ctx context.Context, indexArg int) (types.SetAnyAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetAnyAliasExample, types1.ListUnmarshaler[types.SetAnyAliasExample, interface{}, types1.Any[interface{}]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveSetOptionalAnyAliasExample(ctx context.Context, indexArg int) (types.SetOptionalAnyAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.SetOptionalAnyAliasExample, types1.ListUnmarshaler[types.SetOptionalAnyAliasExample, *interface{}, types1.OptionalUnmarshaler[*interface{}, interface{}, types1.Any[interface{}]]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapBearerTokenAliasExample(ctx context.Context, indexArg int) (types.MapBearerTokenAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapBearerTokenAliasExample, types1.MapUnmarshaler[types.MapBearerTokenAliasExample, bearertoken.Token, bool, types1.BearerToken[bearertoken.Token], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapBinaryAliasExample(ctx context.Context, indexArg int) (types.MapBinaryAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapBinaryAliasExample, types1.MapUnmarshaler[types.MapBinaryAliasExample, binary.Binary, bool, types1.BinaryMapKey[binary.Binary], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapBooleanAliasExample(ctx context.Context, indexArg int) (types.MapBooleanAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapBooleanAliasExample, types1.MapUnmarshaler[types.MapBooleanAliasExample, boolean.Boolean, bool, types1.BooleanMapKey[boolean.Boolean], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapDoubleAliasExample(ctx context.Context, indexArg int) (types.MapDoubleAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapDoubleAliasExample, types1.MapUnmarshaler[types.MapDoubleAliasExample, float64, bool, types1.FloatMapKey[float64], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapIntegerAliasExample(ctx context.Context, indexArg int) (types.MapIntegerAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapIntegerAliasExample, types1.MapUnmarshaler[types.MapIntegerAliasExample, int, bool, types1.Int32MapKey[int], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapRidAliasExample(ctx context.Context, indexArg int) (types.MapRidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapRidAliasExample, types1.MapUnmarshaler[types.MapRidAliasExample, rid.ResourceIdentifier, bool, types1.RID[rid.ResourceIdentifier], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapSafeLongAliasExample(ctx context.Context, indexArg int) (types.MapSafeLongAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapSafeLongAliasExample, types1.MapUnmarshaler[types.MapSafeLongAliasExample, safelong.SafeLong, bool, types1.SafeLongMapKey[safelong.SafeLong], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapStringAliasExample(ctx context.Context, indexArg int) (types.MapStringAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapStringAliasExample, types1.MapUnmarshaler[types.MapStringAliasExample, string, bool, types1.String[string], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapUuidAliasExample(ctx context.Context, indexArg int) (types.MapUuidAliasExample, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapUuidAliasExample, types1.MapUnmarshaler[types.MapUuidAliasExample, uuid.UUID, bool, types1.UUID[uuid.UUID], types1.Boolean[bool]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
...
func (c *autoDeserializeServiceClient) ReceiveMapEnumExampleAlias(ctx context.Context, indexArg int) (types.MapEnumExampleAlias, error) {
	...
	requestParams = append(requestParams, httpclient.WithResponseBody(&returnVal, cj.ClientDecoder[types.MapEnumExampleAlias, types1.MapUnmarshaler[types.MapEnumExampleAlias, types.EnumExample, string, types1.TextUnmarshaler[*types.EnumExample], types1.String[string]]]{}))
	if _, err := c.client.Do(ctx, requestParams...); err != nil {
